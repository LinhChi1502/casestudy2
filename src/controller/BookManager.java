...
public class BookManager {
    ...
    public static void deleteBook() {
        try {
            ...
            System.out.println("Your input is wrong!Do again!");
        }
    ...
    public static void searchBookByName() {
        try {
            ...
            for (Map.Entry<Integer, Book> entry : entries) {
                ...
                if (searchName.equalsIgnoreCase(bookName) || searchName.contains(bookName)) {
    ...
    public static void searchBookByAuthor() {
        try {
            ...
            for (Map.Entry<Integer, Book> entry : entries) {
                ...
                if (searchAuthor.equalsIgnoreCase(author) || searchAuthor.contains(author)) {
